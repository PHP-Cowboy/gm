...
var (
	...
	DataStatusError          = New(508, "数据状态异常")
	GetContextUserInfoFailed = New(509, "获取上下文用户数据失败")
	...
	TokenFormatError       = New(18, "请求头中 Authorization 格式有误")
	ReadBodyError          = New(19, "Failed to read request body")
	DataParsingFailure     = New(20, "数据解析失败")
	SignCheckError         = New(21, "签名验证不通过")
	Release                = New(22, "release")
	CaptchaVerifyFailed    = New(23, "captcha verify failed")
	...
	InsufficientAccountBalance = New(1100, "账户余额不足")
	UserNotRecharge            = New(1101, "The user did not recharge")
	UserRoleChannelNotFound    = New(1102, "用户角色渠道信息未找到")
	OrderStatusAbnormal        = New(1103, "order status abnormal")
)
